...
class Aum256(ControlSurface):
	...
	def __init__(self, c_instance):
		...
		self.log_message("--------------= Aum256 log opened =--------------") 
	...
	def flash(self):
		...
		for button in range(8):
			self._key_button[button].flash(self._timer)
		for button in range(2):
			self._bank_button[button].flash(self._timer)
	...
	def disconnect(self):
		...
		self.log_message("--------------= Aum256 log closed =--------------") #Create entry in log file
