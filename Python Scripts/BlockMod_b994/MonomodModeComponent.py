...
class MonomodModeComponent(ModeSelectorComponent):
	...
	def update(self):
		if (self._mode_index == 0) or (self._script._host._active_client == None):
			...
			self._script._shift_mode.set_mode_toggle(self._script._shift_l, self._script._shift_r)
			...
			self._script._host._set_nav_buttons([self._script._menu[0], self._script._menu[1], self._script._menu[2], self._script._menu[3]])
			self._script._host._set_lock_button(self._script._shift_l)
			self._script._host._set_alt_button(self._script._shift_r)
			self._script._host._set_shift_button(self._script._livid)
			self._script._shift_mode.set_mode_toggle(None, None)
