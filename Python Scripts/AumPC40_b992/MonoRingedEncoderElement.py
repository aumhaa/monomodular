...
class MonoRingedEncoderElement(RingedEncoderElement):
	...
	def __init__(self, msg_type, channel, identifier, map_mode, num, script):
		RingedEncoderElement.__init__(self, msg_type, channel, identifier, map_mode=Live.MidiMap.MapMode.absolute)
		#self.name = name
		self.num = num
		...
		#self.add_value_listener(self._script._notification_to_bridge, True)
