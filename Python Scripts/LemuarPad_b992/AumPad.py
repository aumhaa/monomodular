...
class AumPad(ControlSurface):
	...
	def __init__(self, c_instance):
		...
		self.log_message("--------------= lAumerPad log opened =--------------") 
	...
	def _setup_controls(self):
		...
		self._crossfader = MonoEncoderElement2(MIDI_CC_TYPE, CHANNEL, CROSSFADER, Live.MidiMap.MapMode.absolute, "Crossfader", 24, '/XFader/x', None, None, self)
