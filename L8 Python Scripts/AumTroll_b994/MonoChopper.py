...
class Chopper(ControlSurfaceComponent):
	...
	def _on_tempo_change(self):
		self._tempo = self._cs.song().tempo
		self._div =  45/self._tempo  #this number should be 60, but we've lowered it to accomodate the inacuracy of the Python engine, which seems to change depending on the song tempo. Why does this work?  Beats me.....
