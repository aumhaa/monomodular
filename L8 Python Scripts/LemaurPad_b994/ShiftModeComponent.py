...
class ShiftModeComponent(ModeSelectorComponent):
	...
	def set_mode_toggle(self, button1, button2):
		assert ((button1 == None) or isinstance(button1, ButtonElement or OSCFlashingButtonElement))
		...
		assert ((button2 == None) or isinstance(button2, ButtonElement or OSCFlashingButtonElement))
