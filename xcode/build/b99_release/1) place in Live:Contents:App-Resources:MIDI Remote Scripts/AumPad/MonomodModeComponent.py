...
class MonomodModeComponent(ModeSelectorComponent):
	...
	def set_mode_toggle(self, button):
		assert ((button == None) or isinstance(button, ButtonElement or OSCFlashingButtonElement))
	...
	def update(self):
		if(self._mode_index == 0):
			...
			self._script._host._set_menu_buttons(None)
			...
			#if(self._script.connected_to_monomod is False):
			...
			self._script._host._set_menu_buttons(self._script._menu)
