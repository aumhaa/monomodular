...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.5, 240.0, 14.0, 73.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-112" : [ "matrixctrl[1]", "matrixctrl[1]", 0 ],
			"obj-68" : [ "num", "num", 0 ],
			"obj-37::obj-21" : [ "c_mute", "c_mute", 0 ],
			"obj-122" : [ "matrixctrl", "matrixctrl", 0 ],
			"obj-37::obj-5" : [ "note", "note", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "_xor_midi.maxpat",
				"bootpath" : "/Users/amounra/monomodular_git/aumhaa_blocks/xor",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
