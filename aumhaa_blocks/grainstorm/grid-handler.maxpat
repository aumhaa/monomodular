{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 1235.0, 670.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 1235.0, 670.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s #3trigger",
					"patching_rect" : [ 458.0, 738.040649, 73.0, 20.0 ],
					"id" : "obj-125",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #3momentary",
					"patching_rect" : [ 448.0, 271.04068, 97.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r ---write_enable",
					"patching_rect" : [ 562.0, 489.04068, 98.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 562.0, 634.0, 180.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 562.0, 662.0, 109.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r ---write_enable",
					"patching_rect" : [ 225.0, 439.04068, 98.0, 20.0 ],
					"id" : "obj-302",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend /grainstorm/grid/led/set",
					"patching_rect" : [ 183.605225, 784.0, 180.0, 20.0 ],
					"id" : "obj-82",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s ---grainstorm-out",
					"patching_rect" : [ 183.605225, 812.0, 109.0, 20.0 ],
					"id" : "obj-81",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "matrixctrl",
					"presentation_rect" : [ 1097.0, 210.0, 128.0, 26.0 ],
