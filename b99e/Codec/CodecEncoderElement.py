...
FILL = [[0, 0], [1, 0], [3, 0], [7, 0], [15, 0], [31, 0], [63, 0], [127, 0], [127, 1], [127, 3], [127, 7], [127, 31], [127, 63], [127, 63]]
CENTER =  [[127, 0], [126, 0], [124, 0], [120, 0], [112, 0], [96, 0], [64, 0], [64, 1], [64, 3], [64, 7], [64, 31], [64, 63]]
...
#		self._ring_green_led = [`int(val != 0)`]
	...
	def _get_ring(self):
		if self._ring_mode < 4:
			bytes = RING_MODE[self._ring_mode][self._ring_value % len(RING_MODE[self._ring_mode])]
		else:
			bytes = self._ring_custom[self._ring_value % len(self._ring_custom)]
		bytes.append(self._ring_green * 64)
		return bytes
