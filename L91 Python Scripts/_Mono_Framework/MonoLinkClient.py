#Embedded file name: /Applications/Ableton Live 9.05 Suite.app/Contents/App-Resources/MIDI Remote Scripts/_Mono_Framework/MonoLinkClient.py
...
class MonoLinkClient(MonoClient):
    ...
    def _setup_oscServer(self):
        ...
        self._inPrt = int(self.oscServer.srcPort)
