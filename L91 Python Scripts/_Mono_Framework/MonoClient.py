#Embedded file name: /Applications/Ableton Live 9.05 Suite.app/Contents/App-Resources/MIDI Remote Scripts/_Mono_Framework/MonoClient.py
...
class MonoClient(NotifyingControlElement):
    ...
    def _create_c_wheels(self):
        ...
        for column in range(4):
            ...
            for row in range(3):
                self._c_wheel[column][row] = {'log': 0,
                 'value': 0,
                 'mode': 0,
                 'white': 0,
                 'green': 0,
