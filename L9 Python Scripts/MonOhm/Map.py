...
#		Ohm64 is detected.  The first dictionary determins the color used by the RGB (from the ordering in the COLOR_MAP array),
#		the second the Monochrome.  Obviously the Monochrome doesn't use the colors.  
#	However, the flashing status of a color is derived by modulus.  Thus 1-7 are the raw colors, 8-14 are a fast
