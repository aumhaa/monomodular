...
class APC(ControlSurface):
	...
	def __init__(self, c_instance):
		super(APC, self).__init__(c_instance)
	...
	def _on_handshake_successful(self):
		...
		#for control in self.controls:
			#self.log_message(str(control))
			#if control.name:
			#	self.log_message(str(control.name))
	...
	def _send_midi(self, midi_bytes, optimized = None):
		...
		if not self._suppress_send_midi:
			sent_successfully = ControlSurface._send_midi(self, midi_bytes, optimized)
