#Embedded file name: /Volumes/Jenkins2045_2/versonator2/Hudson/live/Projects/AppLive/Resources/MIDI Remote Scripts/Push/StepSeqComponent.py
...
class StepSeqComponent(CompoundComponent):
	...
	def set_drum_group_device(self, drum_group_device):
		assert( drum_group_device or drum_group_device.can_have_drum_pads )
